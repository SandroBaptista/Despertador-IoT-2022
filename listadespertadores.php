...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-primary" style="font-weight: bold;">Lista de Despertadores</h1><br>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-4">
                            <h6 class="m-0 font-weight-bold text-primary">Escolha o despertador que pretende gerir:
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tabledespertadores" class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                        <tr>
                                            <th>Nome</th>
                                            <th>Endereço IP</th>
                                    ...
                                    <?php
                                                ...
                                                $sql = "SELECT * FROM despertador WHERE id_utilizador=".$_SESSION['idUser'];
    ...
    <script>
        $("#tabledespertadores tr").click(function(){
        $(this).addClass('selected').siblings().removeClass('selected');    
        var value=$(this).find('td:first-child').html();
        var idDespertador=$(this).find('td:last-child').html();
        localStorage.setItem('despertadorId', idDespertador);       
        localStorage.setItem('despertadorname', value);
        createCookie("id", idDespertador, 10);
