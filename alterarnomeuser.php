...
<?php
    ...
    //Obter dados do nome do utilizador atualizados após página ser carregada
    include('database.php');
    $sql = "SELECT nome FROM user WHERE id=".$_SESSION['idUser'];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid text-center">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-primary" style="font-weight: bold;">Definições do Utilizador</h1>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body shadow">
                                            <div class="col">
                                                <form method="post" id="form-add-alarm" action="alterardadosuser.php" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="email" name="user-email" type="email" required>
                                                    </div>
