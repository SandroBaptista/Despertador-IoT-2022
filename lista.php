        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-primary" style="font-weight: bold;">Lista de Alarmes</h1><br>
                        <script>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-4">
                                <h6 class="m-0 font-weight-bold text-primary">Lista de Alarmes
                                    <button class="btn btn-primary btn-sm" type="submit" style="float: right;" onclick="location.href='adicionaralarme.php'">Adicionar Novo Alarme</button>
                                </h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $con = mysqli_connect("localhost","despertador_admin","Despertador_iot48","despertador_iot");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        $sqlnomeMusica = "select nome from musica where id = '$row[7]'";
                                                        $resultnomeMusica = mysqli_query($con, $sqlnomeMusica);


                                                        if ($resultnomeMusica = mysqli_query($con, $sqlnomeMusica)) {
                                                            while ($rownomeMusica = mysqli_fetch_row($resultnomeMusica)) {
                                                                
                                                                echo $rownomeMusica[0];
                                                            }
                                                        }
                                                    ?></td>
