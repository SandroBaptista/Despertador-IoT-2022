        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid text-center">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-primary" style="font-weight: bold;">Perfil</h1>
<br><br>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary font-weight-bold m-0">Informações do utilizador</p>
                                        </div>
                                        <div class="card-body shadow">
                                            <div class="col mr-2">
                                                    <div class="form-group">
                                                            <img class="img-profile rounded-circle" style="width: 150px;"src="img/undraw_profile.svg">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="username">
                                                            <strong>ID: <span class="text-primary"><?php echo $_SESSION['idUser']; ?></span></strong>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Nome: <span class="text-primary"><?php echo $_SESSION['nomeUser']; ?></span></strong>
                                                        </label>
                                                    </div>
                                                    <div class="form-group text-center">
                                                        <button id="edit" onclick="location.href='alterarnomeuser.php'" class="btn btn-primary btn-sm" type="submit">Alterar dados</button>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Despertadores Associados</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                    ...
                                                    <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $sql = "SELECT * FROM despertador WHERE id_utilizador=".$_SESSION['idUser']." LIMIT 0 , 4"; 
                                                                ?>


                                                                <?php if ($result = mysqli_query($conn, $sql)) {
                                                                    $_SESSION['numeroAlarmes'] = mysqli_num_rows($result);
                                                                ?>
                                            ...
                                            <div class="form-group text-center">
                                                <button id="edit" onclick="location.href='listadespertadores.php'" class="btn btn-primary btn-sm" type="submit">Ver Lista Completa</button>              
                                            </div>
                                        </div>
                                    </div>
                                </div>
